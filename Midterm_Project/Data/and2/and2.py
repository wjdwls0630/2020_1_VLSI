...
Original file is located at
    https://colab.research.google.com/drive/1ma1OKWXPJozPJAu1L1StXKPAbUIVcBXJ
"""
...
os.chdir('/content/drive/My Drive/vlsi/Hspice/and2/Pre-Sim/output')
...
panda = pd.DataFrame(list(zip(col01,col02,col03,col04,col05,col06,col07,col08,col09)),
              columns=['tpdf','tpdr','tpd','tcdr','tcd','tr','tf','avgpower','peakpower'])
panda_sliced = panda.drop(list([0]))

writer = ExcelWriter('../and2_Pre-Sim.xlsx')
panda_sliced.to_excel(writer) #can add sheets here if needed
writer.save()

os.chdir('/content/drive/My Drive/vlsi/Hspice/and2/PLS/output')
...
writer = ExcelWriter('../and2_PLS.xlsx')
panda_sliced.to_excel(writer) #can add sheets here if needed
writer.save()